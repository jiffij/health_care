...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const d_MedicalAllergyPage(),
    );
  }
}

class d_MedicalAllergyPage extends StatefulWidget {
  const d_MedicalAllergyPage({super.key});
  ...
  @override
  State<d_MedicalAllergyPage> createState() => _MedicalAllergyPageState();
}

class _MedicalAllergyPageState extends State<d_MedicalAllergyPage> {
  ...
  void start() async {
    ...
    Map<String, dynamic>? emergencydata =
        await readFromServer('doctor/$uid/emergency/emergency');
    print(emergencydata);
  ...
  void updateEmergencyDetail() {
    ...
    writeToServer("doctor/$uid/emergency/emergency", {
