...
class d_MedicalReportListPage extends StatefulWidget {
  const d_MedicalReportListPage({super.key});
  ...
  State<d_MedicalReportListPage> createState() => _MedicalReportListPageState();
}

class _MedicalReportListPageState extends State<d_MedicalReportListPage> {
  ...
  void start() async {
    String uid = getUID();
    List<String> existdatelist = await getColId('doctor/$uid/history');
    print(existdatelist);
    for (var date in existdatelist)
    {
      Map<String, dynamic>? data = await readFromServer('doctor/$uid/history/$date');
      print(data);
      var patientid = data?['patient'];
      data = await readFromServer('patient/$patientid');
                ...
                children: [
                  ...
                  Container (
                    ...
                    child: const FittedBox (
                      ...
                      fit: BoxFit.scaleDown,        
                      child: Text('Search By Patient Name...', style: TextStyle(fontSize: 12)),
                    ),
                  ),
                  const Spacer(),
                  const FittedBox (
