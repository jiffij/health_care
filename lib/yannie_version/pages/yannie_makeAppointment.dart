          ...
          child: Column(
            ...
            children: [
              TimesSlotGridViewFromList(
                ...
                listDates: [
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 9, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 9, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 10, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 10, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 11, 00),
                  ...
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 14, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 14, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 15, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 15, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 16, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 16, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 17, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 17, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 18, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 18, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 19, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 19, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 20, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 20, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 21, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 21, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 22, 00),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 22, 30),
                  DateTime(selectedDay.year, selectedDay.month, selectedDay.day, 23, 00),
